...
public class BinarySearchTree {
    ...
    public void preOrder(Node root) {    //recursive preorder
        if(root == null) {
            return;
        }
    ...
    public void inOrder(Node root) {
        if(root == null) {              //recursive postorde
            return;
        }
    ...
    public int getCount(Node root) {
        ...
        return 1 + getCount(root.getLeft()) + getCount(root.getRight());  //1 of root + its left and right cout
    }

    public int getMax() {   //max element in bst is at right side
        if(root == null) {
            return 0;
        }
        Node temp = root;
...
//    
//    
//    public boolean searchg(int key) {
//    	Node temp=root;
//    	while(temp!=null) {
//    	if(key==root.getData()) {
//    		return true;
